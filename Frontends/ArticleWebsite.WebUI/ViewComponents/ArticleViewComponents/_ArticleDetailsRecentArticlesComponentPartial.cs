...
{
    public class _ArticleDetailsRecentArticlesComponentPartial:ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;
        public _ArticleDetailsRecentArticlesComponentPartial(IHttpClientFactory httpClientFactory)
        {
